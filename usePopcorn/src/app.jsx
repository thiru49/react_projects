...
const NavBar = () => {
  return (
    <div className="flex flex-row justify-between items-center px-10 py-2 bg-indigo-600 rounded-xl shadow-xl text-md">
...
const Main = () => {
  ...
  return (
    <main className="mt-8  h-[70vh] flex gap-2 w-[65%] mx-auto">
      <div className="basis-1/2 relative overflow-auto bg-gray-700 rounded-xl shadow-xl">
        <button className="bg-black size-8 rounded-full absolute right-2 top-2">
          +
        </button>
        {isOpen1 && (
          <ul className="">
